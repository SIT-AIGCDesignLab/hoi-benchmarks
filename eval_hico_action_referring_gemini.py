#!/usr/bin/env python3
"""
HICO-DET Action Referring Evaluation Script for Gemini API
...
Usage:
    python eval_hico_action_referring_gemini.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="HICO-DET Action Referring Evaluation with Gemini API"
    )
    ...
    parser.add_argument('--wandb-project', type=str, default='hico-action-referring-gemini',
    ...
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Evaluation (Gemini API)")
    print("=" * 80)
    ...
    # Print results
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Results (Gemini API)")
    print("=" * 80)
