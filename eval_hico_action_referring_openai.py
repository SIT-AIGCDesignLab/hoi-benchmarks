#!/usr/bin/env python3
"""
HICO-DET Action Referring Evaluation Script for OpenAI API
...
Usage:
    python eval_hico_action_referring_openai.py \
        --model-name gpt-4o \
...
def main():
    parser = argparse.ArgumentParser(
        description="HICO-DET Action Referring Evaluation with OpenAI API"
    )
    ...
    parser.add_argument('--wandb-project', type=str, default='hico-action-referring-openai',
    ...
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Evaluation (OpenAI API)")
    print("=" * 80)
    ...
    # Print results
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Results (OpenAI API)")
    print("=" * 80)
