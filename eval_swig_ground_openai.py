#!/usr/bin/env python3
"""
SWIG-HOI Grounding Evaluation Script for OpenAI API
...
Usage:
    python eval_swig_ground_openai.py \
        --model-name gpt-4o \
...
def call_openai_api_grounding(
    ...
    def _api_call():
        if "o1" in model.lower() or "o3" in model.lower():
            ...
            # GPT-5.x models support reasoning_effort for enhanced spatial reasoning
            return client.chat.completions.create(
                model=model,
                messages=messages,
                max_completion_tokens=4096,
                temperature=1.0,
                reasoning_effort="high"  # Enable deep reasoning for precise bounding boxes
            )
        else:
...
def main():
    parser = argparse.ArgumentParser(description="SWIG-HOI Grounding Evaluation with OpenAI API")
    ...
    parser.add_argument('--wandb-project', type=str, default='swig-grounding-openai')
    ...
    print("\n" + "=" * 80)
    print("SWIG-HOI Grounding Evaluation (OpenAI API)")
    print("=" * 80)
