#!/bin/bash
################################################################################
# HICO-DET Action Referring Evaluation for OpenAI API
# Supports GPT-4o, GPT-4-turbo, o1-preview, o1-mini, GPT-5 (when available)
#
# Usage: bash run_hico_action_referring_eval_openai.sh [MODEL] [OUTPUT_DIR]
#
# Examples:
#   OPENAI_API_KEY=xxx bash run_hico_action_referring_eval_openai.sh
#   bash run_hico_action_referring_eval_openai.sh "o1-preview"
#   bash run_hico_action_referring_eval_openai.sh "gpt-5"  # Future model
#   COMPUTE_BERTSCORE=1 bash run_hico_action_referring_eval_openai.sh
#
...
OUTPUT_DIR="${2:-results/hico_action_openai}"

mkdir -p "$OUTPUT_DIR"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="$OUTPUT_DIR/hico_action_openai_evaluation_${TIMESTAMP}.log"
...
PRED_FILE="${OUTPUT_DIR}/hico_action_openai_results_${TIMESTAMP}.json"

echo "========================================================================"
echo "HICO-DET Action Referring Evaluation (OpenAI API)"
echo "========================================================================"
...
EVAL_CMD="python3 eval_hico_action_referring_openai.py \
