#!/usr/bin/env python3
"""
SWIG-HOI Grounding Evaluation Script for Claude API
...
Usage:
    python eval_swig_ground_claude.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="SWIG-HOI Grounding Evaluation with Claude API"
    )
    ...
    parser.add_argument('--wandb-project', type=str, default='swig-grounding-claude',
    ...
    print("\n" + "=" * 80)
    print("SWIG-HOI Grounding Evaluation (Claude API)")
    print("=" * 80)
    ...
    # Print results
    print("\n" + "=" * 80)
    print("SWIG-HOI Grounding Results (Claude API)")
    print("=" * 80)
