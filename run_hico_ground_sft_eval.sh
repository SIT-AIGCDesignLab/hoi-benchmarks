...
#   WANDB=1 bash run_hico_ground_sft_eval.sh 0
#   IMAGE_ID=HICO_test2015_00000001.jpg bash run_hico_ground_sft_eval.sh 0
#
...
OUTPUT_DIR="${OUTPUT_DIR:-results-sft/hico_ground_sft}"
