#!/bin/bash
################################################################################
# SWIG-HOI Grounding Evaluation for OpenAI API
# Supports GPT-4o, GPT-4-turbo, o1-preview, o1-mini, GPT-5 (when available)
#
# Usage: bash run_swig_ground_eval_openai.sh [MODEL] [OUTPUT_DIR]
#
# Examples:
#   OPENAI_API_KEY=xxx bash run_swig_ground_eval_openai.sh
#   bash run_swig_ground_eval_openai.sh "o1-preview"
#   bash run_swig_ground_eval_openai.sh "gpt-5"  # Future model
#
...
OUTPUT_DIR="${2:-results/swig_ground_openai}"

mkdir -p "$OUTPUT_DIR"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="$OUTPUT_DIR/swig_ground_openai_evaluation_${TIMESTAMP}.log"
...
RESULT_FILE="${OUTPUT_DIR}/swig_ground_openai_results_${TIMESTAMP}.json"

echo "========================================================================"
echo "SWIG-HOI Grounding Evaluation (OpenAI API)"
echo "========================================================================"
...
EVAL_CMD="python3 eval_swig_ground_openai.py \
