#!/bin/bash
################################################################################
# SWIG-HOI Grounding Task Evaluation Script for Gemini API
...
#
# Usage:
#   bash run_swig_ground_eval_gemini.sh [MODEL] [OUTPUT_DIR]
#
# Examples:
#   GOOGLE_API_KEY=xxx bash run_swig_ground_eval_gemini.sh
#   MAX_IMAGES=10 bash run_swig_ground_eval_gemini.sh
#
...
OUTPUT_DIR="${2:-results/swig_ground_gemini}"

mkdir -p "$OUTPUT_DIR"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
LOG_FILE="$OUTPUT_DIR/swig_ground_gemini_evaluation_${TIMESTAMP}.log"
...
RESULT_FILE="${OUTPUT_DIR}/swig_ground_gemini_results_${TIMESTAMP}.json"

echo "========================================================================"
echo "SWIG-HOI Grounding Evaluation (Gemini API)"
echo "========================================================================"
...
EVAL_CMD="python3 eval_swig_ground_gemini.py \
