#!/usr/bin/env python3
"""
HICO-DET Action Referring Evaluation Script for Claude API
...
Usage:
    python eval_hico_action_referring_claude.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="HICO-DET Action Referring Evaluation with Claude API"
    )
    ...
    parser.add_argument('--wandb-project', type=str, default='hico-action-referring-claude',
    ...
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Evaluation (Claude API)")
    print("=" * 80)
    ...
    # Print results
    print("\n" + "=" * 80)
    print("HICO-DET Action Referring Results (Claude API)")
    print("=" * 80)
