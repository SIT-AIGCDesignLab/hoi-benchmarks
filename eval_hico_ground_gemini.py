#!/usr/bin/env python3
"""
HICO-DET Grounding Evaluation Script for Gemini API
...
Usage:
    python eval_hico_ground_gemini.py \
        ...
        --result-file results/hico_grounding_results.json \
...
def call_gemini_api_grounding(
    ...
    def _api_call():
        ...
        # Generate content
        # Gemini 3 uses dynamic thinking by default - use thinking_level="high" for spatial tasks
...
def main():
    parser = argparse.ArgumentParser(
        description="HICO-DET Grounding Evaluation with Gemini API"
    )

    # Model arguments
    parser.add_argument('--model-name', type=str, default='gemini-3-pro-preview',
    ...
    parser.add_argument('--wandb-project', type=str, default='hico-grounding-gemini',
    ...
    print("\n" + "=" * 80)
    print("HICO-DET Grounding Evaluation (Gemini API)")
    print("=" * 80)
    ...
    # Print results
    print("\n" + "=" * 80)
    print("HICO-DET Grounding Results (Gemini API)")
    print("=" * 80)
